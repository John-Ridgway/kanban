...
const ONBOARDING_AGENT_IDS: readonly RuntimeAgentId[] = ["cline", "claude", "codex", "droid", "kiro", "pi"];
...
function resolveInstallInstructions(agentId: RuntimeAgentId): string {
	...
	if (agentId === "pi") {
		return "A minimal, extensible coding agent CLI with support for many model providers.";
	}
