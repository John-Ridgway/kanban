...
export function registerTaskCommand(program: Command): void {
	...
	task
		...
		.option("--agent-id <id>", "Agent override: cline | claude | codex | droid | gemini | opencode | pi | default.")
		.option(
			"--cline-provider <id>",
	...
	task
		...
		.option(
			"--agent-id <id>",
			'Agent override: cline | claude | codex | droid | gemini | opencode | pi. Use "default" to clear.',
		)
		.option(
			"--cline-provider <id>",
